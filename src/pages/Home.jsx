            ...
            <Col lg='6' md='6'>
              <div className='hero__content  '>
                <h1 className='mb-4 hero__title'>
                  <span>HUNGRY?</span> We'll <br /> bring it to
                  <span> your door</span>
                </h1>

                <p>Get your favourite food at your doorsteps. Order Now</p>
            ...
            <Col lg='6' md='6'>
              <div className='why__tasty-treat'>
                <h2 className='tasty__treat-title mb-4'>
                  Why <span>Bon Giono?</span>
                </h2>
                <p className='tasty__treat-desc'>
                  Bon Giono is one of a kind service in Romania. Other services
                  focus on metro cities but we focus on small towns too. Now,
                  they could also benefit and enjoy our services at their
                  doorsteps.
                </p>
                ...
                <ListGroup className='mt-4'>
                  ...
                  <ListGroupItem className='border-0 ps-0'>
                    ...
                    <p className='choose__us-desc'>
                      Location's no more a limit as we are available in smallest
                      of towns.
                    </p>
                  </ListGroupItem>
                </ListGroup>
            ...
            <Col lg='6' md='6'>
              <div className='testimonial '>
                ...
                <p className='testimonial__desc'>
                  A business is always evaluated on what is customers are
                  saying. so let's read what our customers have to say about us!
                </p>
